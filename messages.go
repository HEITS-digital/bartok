...
var waterCoolerRoIntros = []string{
	...
	"Sau cum te-ar intreaba vanzatoarea de la bufet:",
	"Sau cum te-ar intreaba cineva care s-ar preface ca-i pasa:",
...
var waterCoolerQuestions = [][]string{
	...
	{"You’ve died, but instead of entering the afterlife, you’ve entered Earth 2.0. What are some things tha},t make Earth 2.0 better?", "Ai murit, dar în loc să intri în viața de apoi, ai intrat în Pământul 2.0. Care sunt unele lucruri care fac Pământul 2.0 mai bun?"},
	{"If you could go back in time 10,000 years ago and make a cave painting to confuse everyone in the futu},re, what would you draw?", "Dacă ai putea să te întorci în timp cu 10.000 de ani în urmă și să faci o pictură rupestră pentru a deruta pe toată lumea în viitor, ce ai desena?"},
	{"A genie appears and grants you a wish for someone else in the world. Who and what do you make a wish f},or?", "Un geniu apare și îți îndeplinește o dorință pentru altcineva din lume. Cui și ce-i pui o dorință?"},
	...
	{"Would you rather receive a shoutout from the CEO at a company all-hands meeting or a private word of t},hanks from them?",
	{"Would you rather someone took a boring task off your to-do list or invited you to participate in a pro},ject of great interest to you?",
	...
	{"If you could change Halloween’s symbolic pumpkin to another fruit or vegetable, what would it be and w},hy?",
	...
	{"If you could do something that you don’t because it’s bad for you, but you could do it without repercu},ssions – what would you do?",
	...
	{"If you had a time machine, would you go back in time to meet your ancestors or forward to meet your de},scendants?",
	...
	{"If you were handed a megaphone and could blast out one message for the entire world to hear, what woul},d you say?",
	...
	{"What is one thing your parents or guardians did right? And what’s one thing you wish they’d done diffe},rently?",
	...
	{"What’s a landmark, popular destination, or local hangout spot that you either frequented or avoided wh},en growing up?",
